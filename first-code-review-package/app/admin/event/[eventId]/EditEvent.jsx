  ...
  const fetchEventData = async () => {
    ...
    if (docSnap.exists()) {
      ...
      setFormData({
        ...
        // TODO the event date setState logic is broken, 
        //mthis line triggers a react infinite update loop
  ...
  return (
    <div>
      <Form onFinish={() => handleSave(formData)}>
        ...
        <Form.Item>
          {/* TODO: temporarily disabled to await the datepicker to be fixed */}
